...
$sql3="select count(*) as total from articles";
$result3=mysqli_query($conn,$sql3);
$data3=mysqli_fetch_assoc($result3);


$sql4="select * from visit";
$result4=mysqli_query($conn,$sql4);
$data4=mysqli_fetch_assoc($result4);


// $sql2="select count(*) as total from schedule_meeting ";
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Total Users</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $data1['total']?></div>
                                        </div>
                                        <div class="col-auto">
                            ...
                            <div class="card border-left-success shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="col-auto">
                                            <i class="fab fa-forumbee fa-2x text-gray-300"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Total Articles
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            Total Visitors</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $data4['total_count'];?></div>
                                        </div>
                                        <div class="col-auto">
