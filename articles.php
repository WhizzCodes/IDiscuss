  ...
  <?php include 'header.php'?>
    ...
    <section class="u-align-center u-clearfix u-section-1" id="carousel_a292">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h2 class="u-align-center u-text u-text-1">Articles By Users </h2>
        <!-- <p class="u-text u-text-2">Articles</p> -->
        <div class="u-form u-form-1">
          <form method="POST" style="padding: 15px;" source="custom">
            <div class="u-form-group u-form-name">
              ...
              <input type="text" placeholder="Search" id="name-ef64" name="cat" class="u-border-1 u-border-grey-30 u-input u-input-rectangle">
            </div>
    ...
    while($row=mysqli_fetch_assoc($res)){
      ...
      $id=$row['art_id'];
              $cat=$row['art_title'];
              $desc=$row['art_content'];
              echo'  <div class="u-container-style u-list-item u-repeater-item">
                  <div class="u-container-layout u-similar-container u-container-layout-1">
                    <img class="u-expanded-width-sm u-expanded-width-xs u-image u-image-1" src="'.$row['art_banner_pic'].'" data-image-width="1600" data-image-height="900">
                    <div class="u-align-center u-container-style u-expanded-width-sm u-expanded-width-xl u-expanded-width-xs u-group u-shape-rectangle u-group-1">
                      <div class="u-container-layout u-container-layout-2">
                        <h3 class="u-text u-text-3"><a href="threadlist.php?catid='.$id.'">'.substr($cat, 0,30).'</a></h3>
                        <h6 class="u-text u-text-4">'.substr($desc, 0,50).'...</h6>
                        <br>
    ...
    echo'  <div class="u-container-style u-list-item u-repeater-item">
        <div class="u-container-layout u-similar-container u-container-layout-1">
          ...
          <div class="u-align-center u-container-style u-expanded-width-sm u-expanded-width-xl u-expanded-width-xs u-group u-shape-rectangle u-group-1">
            <div class="u-container-layout u-container-layout-2">
              <h3 class="u-text u-text-3"><a href="post.php?articleid='.$id.'">'.substr($cat, 0,30).'</a></h3>
              <h6 class="u-text u-text-4">'.substr($desc, 0,50).'...</h6>
              <br>
              <a href="post.php?articleid='.$id.'" class="btn btn-primary">View Article</a>
            </div>
          </div>
        </div>
      </div>';
