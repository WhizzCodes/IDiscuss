...
<body class="u-body">
      ...
      <div class="u-form u-form-1">
        <form action="#" method="POST" >
          <div class="u-form-group u-form-name">
            ...
            <input type="text" placeholder="Name" id="name-ef64" name="nsearch"
          ...
          <div class="u-form-group u-form-submit">
            ...
            <input type="submit" name="searchp" value="submit" class="u-form-control-hidden">
          </div>
        </form>
      </div>
    </div>
  ...
  <?php 
          if(isset($_POST['searchp'])){
            $id=$_GET['catid'];
            $search=$_POST['search'];
            $sqls="SELECT * FROM threads WHERE ( thread_title LIKE '%$search%' AND thread_cat_id=$id )";
            ...
            $sql="SELECT * FROM threads WHERE ( thread_title LIKE '%$search%' AND thread_cat_id=$id )";
            $result=mysqli_query($conn,$sql);
            $record=mysqli_num_rows($result);
            $pagi=ceil($record/$per_page);
            $sqld="SELECT * FROM threads WHERE ( thread_title LIKE '%$search%' AND thread_cat_id=4 ) ORDER BY thread_id DESC limit $start,$per_page";
